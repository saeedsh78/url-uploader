...
@pyrogram.Client.on_message(pyrogram.filters.command(["generatecustomthumbnail"]) & pyrogram.filters.user(Config.OWNER_ID))
...
@pyrogram.Client.on_message(pyrogram.filters.photo & pyrogram.filters.user(Config.OWNER_ID))
...
@pyrogram.Client.on_message(pyrogram.filters.command(["deletethumbnail"]) & pyrogram.filters.user(Config.OWNER_ID))
